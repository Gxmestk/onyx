...
# corpus-patch: lowered from 512. The embedding server (vLLM SEA-LION-E5) has a
# hard 512-token limit that INCLUDES the BOS/EOS special tokens it adds
# server-side (verified: 510 content + 2 special = 512 OK; 511 + 2 = 513 -> 400).
# Chunk at 500 content tokens for a safety margin.
DOC_EMBEDDING_CONTEXT_SIZE = 500
